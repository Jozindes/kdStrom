 ...
 * @author Jozef
 */
public class ZoznamParciel extends javax.swing.JFrame {
    private static Spravca instancia;
    private ArrayList<Vrchol> zoznamNajdenych;
    /**
     * Creates new form ZoznamParciel
     */
    public ZoznamParciel(Spravca paInstancia) {
        initComponents();
        this.instancia = paInstancia;
    }
    
    public void vyplnTabulkuParciel() {
        ...
        DefaultTableModel model = (DefaultTableModel) tabulkaParciel.getModel();
        ...
        this.zoznamNajdenych = zoznamParciel;
    }
    ...
    private void initComponents() {
        ...
        tabulkaParciel = new javax.swing.JTable();
        ...
        jLabel5.setText("Vyhľadanie parciel");

        tabulkaParciel.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tabulkaParciel);
    ...
    private void upravitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_upravitActionPerformed
        int column = 0;
        int row = tabulkaParciel.getSelectedRow();
        int vybrane = (int) tabulkaParciel.getModel().getValueAt(row, column);
    ...
    private void zmazActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zmazActionPerformed
        int row = tabulkaParciel.getSelectedRow();
        String value = tabulkaParciel.getModel().getValueAt(row, 1).toString();
        double zvalue1 = Double.parseDouble(value);
        value = tabulkaParciel.getModel().getValueAt(row, 3).toString();
        ...
        String supi = tabulkaParciel.getModel().getValueAt(row, 5).toString();
        int sup = Integer.parseInt(supi);
        String popis = tabulkaParciel.getModel().getValueAt(row, 6).toString();
        ...
        for (Vrchol akt : this.zoznamNajdenych) {
            if ((akt.dajKlucNaIndexe(0).dajHodnotuKluca().compareTo(poleSuradnic[0].dajHodnotuKluca()) == 0) &&
                ...
                if ((akt.dajNehnutelnost().dajSupisneCislo() == sup) && (akt.dajNehnutelnost().dajPopis() == popis)) {
                    instancia.zmazParcelu(akt.dajPoleKlucov(), akt.dajNehnutelnost());
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ZoznamParciel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ZoznamParciel(instancia).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tabulkaParciel;
